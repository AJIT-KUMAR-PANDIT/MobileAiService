      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400">
              All language processing happens locally in your browser using WebLLM. No data sent to external servers.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400">
              Interact naturally through voice commands with advanced speech recognition and natural-sounding responses.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400">
              Switch between voice and text modes. Get detailed responses to your questions in a conversational interface.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <p className="mb-4 text-gray-300 leading-relaxed">
            This application demonstrates a cross-platform AI assistant that runs directly in your browser. Built with 
            WebLLM, React, and modern web technologies, it provides a futuristic interface for both voice and text interactions.
          </p>
          <p className="mb-4 text-gray-300 leading-relaxed">
            When you activate the assistant, the required AI model will automatically download and be stored locally in your 
            browser's IndexedDB. This ensures your data stays private and allows the application to function offline once downloaded.
          </p>
